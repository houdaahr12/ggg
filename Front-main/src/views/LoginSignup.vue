                    ...
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8">
                        ...
                        <v-row>
                          ...
                          <v-row>
                          <v-col cols="12" sm="10">
                            <span class="text-purple">Mot de passe oublié</span>
                          </v-col>
                        </v-row>
                        <v-btn  class="buttons" block tile @click="login">Se connecter</v-btn>
                  ...
                  <v-card-text class="mt-12">
                    ...
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8">
                        ...
                        <v-btn class="buttons" block tile :disabled="!acceptTerms" @click="signup">S'inscrire</v-btn>
...
const email = ref("");
// const emailRules = {
//   required: value => !!value  'Email est requis.',
//   email: value => /.+@.+\..+/.test(value)  'Veuillez entrer un email valide.',
// };
const password = ref("");
...
/* Style personnalisé pour le v-btn */
.custom-v-btn {
  padding: 1.3em 3em;
  font-size: 12px;
